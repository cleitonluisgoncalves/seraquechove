(function() {
    'use strict';
    $("body").append("<div class='tempo-popup'><div class='content-popup'><span class='fas fa-sun'></span><h3>Solzao</h3><h4>Nesse momento,</h4><h5>última atualização 21/12 - 18:00</h5></div><div class='button-popup'><span class='fas fa-meteor'></span></div></div>");
