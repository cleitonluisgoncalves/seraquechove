(function() {
    'use strict';
    $("body").append("<div class='tempo-popup'><div class='content-popup'><span class='fas fa-rain'></span><h3>Chuvão</h3><h4>Nesse momento,</h4><h5>última atualização 03/01- 15:00</h5></div><div class='button-popup'><span class='fas fa-meteor'></span></div></div>");
